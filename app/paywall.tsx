...
export default function PaywallScreen() {
  ...
  const features = [
    ...
    {
      icon: <FileSignature size={20} color={theme.accent} />,
      title: t('feat1Title'),
      desc: t('feat1Desc'),
    },
    {
      icon: <Fingerprint size={20} color={theme.purple} />,
      title: t('feat2Title'),
      desc: t('feat2Desc'),
    },
    {
      ...
      <ScrollView style={{ flexGrow: 0, flexShrink: 1 }} showsVerticalScrollIndicator={false} contentContainerStyle={{ ...tabletColumn }}>
        ...
        <LinearGradient
          ...
          {/* Fixed light ink, because the gradient under it is fixed dark.
              ...
              dark navy card, a contrast ratio of about 1:1. A surface that does
              not change with the appearance must not take ink that does. */}
